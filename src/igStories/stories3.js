...
console.log(
        chalk`{bold.yellow
  View all story from feeds, Thanks for your donation 🙆\n}`);
            ...
            case 9:
                ...
                excute = function (nextRequestDelay) { return __awaiter(void 0, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, reelsTray.items()];
                            case 1:
                                reelsTrayItems = _a.sent()
                                ;
                                unseenReelsTrayItems = reelsTrayItems
                                    .filter(function (_a) {
                                ...
                                if (unseenReelsTrayItems.length < 1) {
                                    console.log(chalk`{bold - Nothing to seen...}`);
                                    console.log("- Sleeping for " + nextRequestDelay / 60000 + " minutes...");
                                    return [2 /*return*/];
                                }
                                ...
                                console.log(chalk`{bold Unseen users : }` + unseenUsers.join(', '));
                                console.log('\n');
                                _loop_1 = function (user) {
                                    ...
                                    return __generator(this, function (_a) {
                                        switch (_a.label) {
                                            ...
                                            case 1:
                                                _a.sent();
                                                console.log("• @"+user.user.username +chalk.bold.green(` Story mark as seen `));               
                                                                            
                                                delay = generateRandomNumber(1, 10) * 10000 // Delay for next view
                                                ;
                ...
                // Delay
                loop = function () {
                    var delay = generateRandomNumber(3, 5) * 60000;
                    console.log('\n');
                    console.log(chalk.blue('> Collecting users...'));
                    console.log('\n');
                    excute(delay);
...
function resolveCheckpoint() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    console.log("Challenge required!, try Requesting sms-code or click \"It was me\" button");
                ...
                case 3:
                    ...
                    if (!checkpointSuccess) {
                        console.log('Could not resolve checkpoint, exit ...');
                        process.exit(1);
                    }
                    else {
                        console.log('Checkpoint resolve, next step!');
                    }
                    return [2 /*return*/];
            }
        });
